...
func (p *PbftNode) set2DMap(isPrePareConfirm bool, key string, val *shard.Node) {
	if isPrePareConfirm {
...
func (p *PbftNode) getNeighborNodes() []string {
...
func (p *PbftNode) writeCSVline(str []string) {
